 ...
 * ══════════════════════════════════════════════════════════════════════════ */
var ST_CFG = {
  ON: 0,             /* 기본 끔. 물리적으로는 실재하지만(bot-dev/probe_slowthunder.mjs 에서
                      * 8프레임 만에 x=242 착지 확인) 실전 랠리에서는 발동하지 않는다.
                      * 12경기 동안 후보 140만 개를 굴려 2차 파워히트가 난 것은 39개,
                      * 그중 상대가 못 닿는 것은 0개. 조건을 완화해도 승률이 한 자리도
                      * 안 바뀌었다. 코드는 근거와 함께 남겨둔다. */
