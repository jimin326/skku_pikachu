...
> 생성기: `tools/build_v12.mjs`  
> 회귀 테스트: `tools/v12_regression.mjs`
...
| 파일 | 역할 |
|---|---|
| `bot/OurBot_v11.js` | Thunder 원본 및 비교 기준 |
| `bot/AdaptiveCounter_v5_2.js` | 일반 플레이 원본 |
| `bot/Sajamokneun_v3_2.js` | 모델 기반 탐색·상태 인식 연구 원본 |
| `Lion_Eating_Bank_v1.js` | 최종 생성된 단일 파일 봇 |
| `tools/build_v12.mjs` | v12 생성기와 통합 로직의 실제 소스 |
| `tools/v12_regression.mjs` | 고정 시드, 썬더 parity, 실행시간 회귀 테스트 |
| `tools/sim.mjs` | 포인트 단위 헤드리스 시뮬레이터 |
| `tools/sim_real.mjs` | READY·점수·연속 tick을 포함한 실게임형 하니스 |
